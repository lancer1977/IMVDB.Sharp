...
Generated: `2026-06-23T17:09:46.426941+00:00`
Model lane: `auto`
Preparedness input: `/mnt/data/lancer1977/code/Api.IMVDB/.devstudio/runtime/codebase-snapshot/preparedness.json`

- Scope roots: `/mnt/data/lancer1977/code/Api.IMVDB`
...
## Top recommendations
- `/mnt/data/lancer1977/code/Api.IMVDB` — readiness `78` / priority `60`
  ...
  - Dependency status: `warn`
    - `dotnet` manifests: `PolyhydraGames.IMVDB.Api/PolyhydraGames.IMVDB.csproj, PolyhydraGames.IMVDB.Test/PolyhydraGames.IMVDB.Test.csproj`
